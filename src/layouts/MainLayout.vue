...
.top-header {
  ...
  box-shadow: 0 10px 40px rgba(0,0,0,0.09), 
              0 4px 12px rgba(177, 162, 143, 0.15);
  border-bottom: 3px solid #B1A28F;
  position: fixed;
  top: 0;
  left: 0;
  right: 260px;
...
.notifications-dropdown {
    ...
    background: linear-gradient(135deg, #ffffff 0%, #fdfbf7 100%);
    border-radius: 20px; 
    box-shadow: 0 16px 50px -10px rgba(0,0,0,0.15), 
                0 10px 20px -8px rgba(177, 162, 143, 0.2);
...
.unread-dot {
    width: 10px; 
    height: 10px; 
    background: linear-gradient(135deg, #B1A28F 0%, #d4c4a8 100%); 
    border-radius: 50%;
    position: absolute; 
    top: 50%; 
    left: 14px;
    ...
    box-shadow: 0 0 0 3px rgba(177, 162, 143, 0.2),
                0 2px 6px rgba(177, 162, 143, 0.4);
...
/* Sidebar - Enhanced Luxury with Vitality */
.sidebar {
  position: fixed; 
  top: 0; 
  right: 0; 
...
.sidebar-logo-img {
    ...
    border-radius: 14px;
    object-fit: cover;
    border: 2px solid rgba(177, 162, 143, 0.5);
    flex-shrink: 0;
...
.nav-item:hover { 
  ...
  color: #f8fafc;
  border-color: rgba(177, 162, 143, 0.25);
  box-shadow: 0 6px 20px rgba(177, 162, 143, 0.15);
...
.nav-item.active { 
  background: linear-gradient(90deg, rgba(177, 162, 143, 0.18) 0%, rgba(177, 162, 143, 0.05) 100%); 
  color: #B1A28F; 
  font-weight: 700; 
  border-right: 4px solid #B1A28F;
  box-shadow: -8px 0 20px rgba(177, 162, 143, 0.15), 
              inset 2px 0 8px rgba(177, 162, 143, 0.1);
  transform: translateX(-2px);
}
...
.nav-item::after {
  ...
  box-shadow: 0 8px 24px rgba(0,0,0,0.25),
              0 4px 12px rgba(177, 162, 143, 0.3);
  z-index: 300;
  letter-spacing: 0.02em;
...
.nav-item::after::before {
  ...
  border-color: transparent transparent transparent #B1A28F;
}
...
.sidebar:hover .avatar {
  ...
  box-shadow: 0 8px 24px rgba(177, 162, 143, 0.3);
}
...
.footer { 
  height: 65px; 
  background: linear-gradient(135deg, #ffffff 0%, #fdfbf7 100%); 
  border-top: 2px solid rgba(177, 162, 143, 0.15); 
  display: flex; 
  align-items: center; 
  justify-content: center; 
  margin-right: 260px; 
