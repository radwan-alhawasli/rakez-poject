...
const adminItems = [
  ...
  { ...COMMON_ITEMS.tasks },
  { to: '/agents', label: 'الوكلاء / Agents', tooltip: 'الوكلاء', icon: ICONS.agents },
  { to: '/knowledge-management', label: 'قاعدة المعرفة', tooltip: 'قاعدة المعرفة', icon: ICONS.knowledge, permission: 'manage-ai-knowledge' },
  { to: '/commission-deposits/dashboard', label: 'العمولات والودائع', tooltip: 'العمولات والودائع', icon: ICONS.money },
  ...
  { to: '/credit/claim-files', label: 'ملفات المطالبة والإفراغات', tooltip: 'ملفات المطالبة', icon: ICONS.file },
  ...
  { to: '/accounting/deposits', label: 'العربون والمتابعة', tooltip: 'العربون والمتابعة', icon: ICONS.clock },
...
const creditItems = [
  ...
  { to: '/credit/claim-files', label: 'إصدار ملف المطالبة والإفراغات', tooltip: 'إصدار ملف المطالبة والإفراغات', icon: ICONS.file },
  COMMON_ITEMS.exclusiveRequest,
  COMMON_ITEMS.aiAssistant,
  COMMON_ITEMS.profile,
];
...
const accountingItems = [
  ...
  { to: '/accounting/deposits', label: 'إدارة العربون والمتابعة', tooltip: 'إدارة العربون والمتابعة', icon: ICONS.clock },
