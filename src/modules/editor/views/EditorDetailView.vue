...
const FIELD_LABELS = {
  ...
  completion_certificate_url: 'شهادة الإتمام (قديم)',
  prices_units_url: 'أسعار الوحدات',
  marketing_license_url: 'شهادة اتمام و ضمانات',
  advertiser_section_url: 'رقم المعلن',
...
<style scoped src="./styles/EditorDetailView.scoped.s1.css"></style>
