 ...
 *
 * @param {import('vue').Ref<any[]>} items - Reactive array of items to virtualize
 ...
 * @returns {{ parentRef: import('vue').Ref<any>, virtualRows: import('vue').ComputedRef<any[]>, totalSize: import('vue').ComputedRef<number>, scrollToIndex: Function }}
 */
