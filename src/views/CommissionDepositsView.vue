          ...
          <table class="metrics-table">
            ...
            <tbody>
              <tr v-for="commission in commissions" :key="commission.id">
                ...
                <td><span class="status-tag good">{{ commission.status || 'قيد المعالجة' }}</span></td>
                <td>
                  <button class="btn-action edit" @click="viewCommissionDetail(commission)">عرض</button>
                </td>
              </tr>
              <tr v-if="commissions.length === 0 && !isLoading">
                <td colspan="4" style="text-align: center; padding: 40px; color: #94a3b8;">لا توجد عمولات</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table class="metrics-table">
            ...
            <tbody>
              <tr v-for="deposit in deposits" :key="deposit.id">
                ...
                <td><span class="status-tag good">{{ deposit.status || 'معلق' }}</span></td>
                <td>
                  <button class="btn-action edit" @click="viewDepositDetail(deposit)">عرض</button>
                </td>
              </tr>
              <tr v-if="deposits.length === 0 && !isLoading">
                <td colspan="4" style="text-align: center; padding: 40px; color: #94a3b8;">لا توجد ودائع</td>
              </tr>
            </tbody>
          </table>
        </div>
