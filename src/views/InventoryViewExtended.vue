...
const InventoryDashboardTab = defineAsyncComponent(() => import('@/components/inventory/InventoryDashboardTab.vue'));
const InventoryProjectsTab = defineAsyncComponent(() => import('@/components/inventory/InventoryProjectsTab.vue'));
const InventoryContractsTab = defineAsyncComponent(() => import('@/components/inventory/InventoryContractsTab.vue'));
const InventoryAISuggestionsTab = defineAsyncComponent(() => import('@/components/inventory/InventoryAISuggestionsTab.vue'));
