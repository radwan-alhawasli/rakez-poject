...
.marketing-view .stat-icon-bg svg { width: 36px; height: 36px; position: relative; z-index: 1; color: #C4BDB0; filter: drop-shadow(0 0 10px rgba(196, 189, 176, 0.6)); }
.marketing-view .stat-icon-bg { background: linear-gradient(135deg, #1a2a4a 0%, #2c4a7c 50%, #3b6098 100%); color: #C4BDB0; box-shadow: 0 0 16px rgba(196, 189, 176, 0.35); }
