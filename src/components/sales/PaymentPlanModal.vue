      ...
      <div class="modal-body">
        ...
        <div v-else>
          ...
          <div v-if="installments.length > 0" class="installments-list">
            ...
            <div v-for="(installment, index) in installments" :key="installment.id || index" class="installment-item">
          ...
          <div class="installment-form-section">
            <h3 class="section-title">{{ editingIndex !== null ? 'تعديل الدفعة' : 'إضافة دفعة جديدة' }}</h3>
            <form @submit.prevent="saveInstallment" class="installment-form">
              ...
              <div class="form-actions">
                ...
                <button type="submit" class="btn-primary" :disabled="isSaving">
                  <span v-if="!isSaving">{{ editingIndex !== null ? 'حفظ التعديلات' : 'إضافة الدفعة' }}</span>
