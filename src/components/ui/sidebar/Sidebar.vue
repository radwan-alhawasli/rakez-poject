...
<template>
  <aside
    :class="
      cn(
        'sidebar sidebar-component fixed top-0 z-[var(--z-sidebar)] flex h-full flex-col overflow-hidden transition-[width,margin,opacity,transform] duration-200 ease-[cubic-bezier(0.175,0.885,0.32,1.275)]',
