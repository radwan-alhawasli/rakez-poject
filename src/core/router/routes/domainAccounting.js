...
export default {
  ...
  children: [
    ...
    { path: 'projects', name: 'AccountingProjects', component: () => import('@/modules/accounting/views/AccountingView.vue'), meta: { permissions: [PERMISSIONS.ACCOUNTING_SOLD_UNITS_VIEW] } },
