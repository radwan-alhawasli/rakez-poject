...
export default [
  ...
  {
    path: 'admin/commissions-rewards',
    name: 'AdminCommissionsRewards',
    component: () => import('@/modules/admin/views/AdminCommissionsRewardsPage.vue'),
    meta: { permissions: [PERMISSIONS.ACCOUNTING_SOLD_UNITS_VIEW], roles: [ROLE_ADMIN, ROLE_ACCOUNTING] },
  },
  {
    path: 'admin/commissions-rewards/projects/:projectId',
    name: 'AdminCommissionRewardsProject',
    component: () => import('@/modules/admin/views/AdminCommissionRewardsProjectPage.vue'),
    meta: { permissions: [PERMISSIONS.ACCOUNTING_SOLD_UNITS_VIEW], roles: [ROLE_ADMIN, ROLE_ACCOUNTING] },
  },
