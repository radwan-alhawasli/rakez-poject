...
describe('contractService', () => {
  ...
  describe('getAllContracts', () => {
    ...
    it('returns empty on error', async () => {
      mock.onGet('/admin/contracts/adminIndex').reply(500, createErrorResponse('Server error', 500))
      const result = await contractService.getAllContracts()
  ...
  describe('updateContractStatus', () => {
    it('patches admin status', async () => {
      mock.onPatch('/admin/contracts/adminUpdateStatus/1').reply(200, { data: { status: 'approved' } })
  ...
  describe('rejectContract', () => {
    it('calls updateContractStatus with rejected', async () => {
      mock.onPatch('/admin/contracts/adminUpdateStatus/1').reply(200, { data: { status: 'rejected' } })
  ...
  describe('updateContractStatusProjectManager', () => {
    ...
    it('handles error', async () => {
      ...
      await expect(contractService.updateContractStatusProjectManager(1, 'approved')).rejects.toThrow()
    })
  })
