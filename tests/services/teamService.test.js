...
describe('teamService', () => {
  ...
  describe('updateTeam', () => {
    it('should update a team', async () => {
      ...
      mock.onPost(`/project_management/teams/update/${teamId}`).reply(200, { data: { id: teamId } })
  ...
  describe('deleteTeam', () => {
    it('should delete a team', async () => {
      const teamId = 1
      mock.onDelete(`/project_management/teams/delete/${teamId}`).reply(200, { data: { deleted: true } })
  ...
  describe('addTeamsToContract', () => {
    it('should add teams to a contract', async () => {
      ...
      mock.onPost(`/project_management/teams/add/${contractId}`).reply(200, { data: { added: true } })
  ...
  describe('Error Handling', () => {
    ...
    it('should handle 422 Validation Error for createTeam', async () => {
      mock.onPost('/project_management/teams/store').reply(422, { error: 'Validation failed', errors: { name: ['Required'] } })
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle empty team data object', async () => {
      mock.onPost('/project_management/teams/store').reply(422, { error: 'Missing required fields' })
