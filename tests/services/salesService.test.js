...
describe('salesService', () => {
  ...
  describe('confirmReservation', () => {
    it('should confirm a reservation', async () => {
      ...
      mock.onPost(`/sales/reservations/${reservationId}/confirm`).reply(200, { data: { confirmed: true } })
  ...
  describe('cancelReservation', () => {
    it('should cancel a reservation', async () => {
      const reservationId = 1
      mock.onPost(`/sales/reservations/${reservationId}/cancel`).reply(200, { data: { cancelled: true } })
  ...
  describe('updateEmergencyContacts', () => {
    it('should update emergency contacts', async () => {
      ...
      mock.onPatch(`/sales/projects/${projectId}/emergency-contacts`).reply(200, { data: { updated: true } })
  ...
  describe('updateMyTarget', () => {
    it('should update my target', async () => {
      const targetData = { target: 1500000 }
      mock.onPatch('/sales/targets').reply(200, { data: { updated: true } })
  ...
  describe('convertToReservation', () => {
    it('should convert waiting list to reservation', async () => {
      ...
      mock.onPost(`/sales/waiting-list/${waitingListId}/convert`).reply(200, { data: { reservation_id: 1 } })
  ...
  describe('approveNegotiation', () => {
    it('should approve negotiation', async () => {
      ...
      const approvalData = {}
      mock.onPost(`/sales/negotiations/${negotiationId}/approve`).reply(200, { data: { approved: true } })
  ...
  describe('rejectNegotiation', () => {
    it('should reject negotiation', async () => {
      ...
      mock.onPost(`/sales/negotiations/${negotiationId}/reject`).reply(200, { data: { rejected: true } })
  ...
  describe('updatePaymentInstallment', () => {
    it('should update payment installment', async () => {
      ...
      mock.onPut(`/sales/payment-installments/${installmentId}`).reply(200, { data: { id: installmentId, ...updateData } })
  ...
  describe('deletePaymentInstallment', () => {
    it('should delete payment installment', async () => {
      const installmentId = 1
      mock.onDelete(`/sales/payment-installments/${installmentId}`).reply(200, { data: { deleted: true } })
  ...
  describe('updateMarketingTask', () => {
    it('should update marketing task', async () => {
      ...
      mock.onPatch(`/sales/marketing-tasks/${taskId}`).reply(200, { data: { id: taskId, ...updateData } })
