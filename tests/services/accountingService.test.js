...
describe('accountingService', () => {
  ...
  describe('markNotificationAsRead', () => {
    it('should mark notification as read', async () => {
      ...
      mock.onPost(`/accounting/notifications/${notificationId}/read`).reply(200, createSuccessResponse({ id: notificationId, read: true }))
  ...
  describe('markAllNotificationsAsRead', () => {
    it('should mark all notifications as read', async () => {
      mock.onPost('/accounting/notifications/read-all').reply(200, createSuccessResponse({ success: true }))
  ...
  describe('getSoldUnitById', () => {
    it('should fetch sold unit details', async () => {
      ...
      mock.onGet(`/accounting/sold-units/${reservationId}`).reply(200, createSuccessResponse(mockUnit))
  ...
  describe('createManualCommission', () => {
    it('should create manual commission', async () => {
      ...
      mock.onPost(`/accounting/sold-units/${reservationId}/commission`).reply(201, createSuccessResponse({ id: 1, ...commissionData }))
  ...
  describe('updateDistributions', () => {
    it('should update commission distributions', async () => {
      ...
      mock.onPut(`/accounting/commissions/${commissionId}/distributions`).reply(200, createSuccessResponse({ id: commissionId, ...distributionData }))
  ...
  describe('approveDistribution', () => {
    it('should approve commission distribution', async () => {
      ...
      mock.onPost(`/accounting/commissions/${commissionId}/distributions/${distributionId}/approve`).reply(200, createSuccessResponse({ approved: true }))
  ...
  describe('rejectDistribution', () => {
    it('should reject commission distribution', async () => {
      ...
      mock.onPost(`/accounting/commissions/${commissionId}/distributions/${distributionId}/reject`).reply(200, createSuccessResponse({ rejected: true }))

      const result = await accountingService.rejectDistribution(commissionId, distributionId, rejectionData)
  ...
  describe('confirmPayment', () => {
    it('should confirm commission payment', async () => {
      ...
      const result = await accountingService.confirmPayment(commissionId, distributionId, paymentData)
  ...
  describe('confirmDeposit', () => {
    it('should confirm deposit receipt', async () => {
      ...
      mock.onPost(`/accounting/deposits/${depositId}/confirm`).reply(200, createSuccessResponse({ id: depositId, confirmed: true }))
  ...
  describe('processRefund', () => {
    it('should process deposit refund', async () => {
      ...
      mock.onPost(`/accounting/deposits/${depositId}/refund`).reply(200, createSuccessResponse({ id: depositId, refunded: true }))
  ...
  describe('generateClaimFile', () => {
    it('should generate deposit claim file', async () => {
      const reservationId = 100
      mock.onPost(`/accounting/deposits/claim-file/${reservationId}`).reply(200, createSuccessResponse({ file_url: 'https://example.com/claim.pdf' }))
  ...
  describe('createDistribution', () => {
    it('should create salary distribution', async () => {
      const employeeId = 1
      const distributionData = { month: 2, year: 2026, base_salary: 8000, total_commissions: 12500 }
  ...
  describe('approveSalaryDistribution', () => {
    it('should approve salary distribution', async () => {
      ...
      mock.onPost(`/accounting/salaries/distributions/${distributionId}/approve`).reply(200, createSuccessResponse({ approved: true }))
  ...
  describe('markSalaryAsPaid', () => {
    it('should mark salary as paid', async () => {
      ...
      mock.onPost(`/accounting/salaries/distributions/${distributionId}/paid`).reply(200, createSuccessResponse({ paid: true }))
  ...
  describe('getPendingConfirmations', () => {
    it('should fetch pending confirmations (Legacy)', async () => {
      ...
      mock.onGet('/accounting/pending-confirmations').reply(200, createSuccessResponse(mockConfirmations))
  ...
  describe('confirmDownPayment', () => {
    it('should confirm down payment (Legacy)', async () => {
      const reservationId = 100
      mock.onPost(`/accounting/confirm/${reservationId}`).reply(200, createSuccessResponse({ confirmed: true }))
  ...
  describe('getConfirmationHistory', () => {
    it('should fetch confirmation history (Legacy)', async () => {
      ...
      mock.onGet('/accounting/confirmations/history').reply(200, createSuccessResponse(mockHistory))
  ...
  describe('Error Handling', () => {
    ...
    it('should handle 403 Forbidden', async () => {
      mock.onPost('/accounting/sold-units/100/commission').reply(403, createErrorResponse('Forbidden', 403))

      await expect(accountingService.createManualCommission(100, {})).rejects.toThrow()
    })

    it('should handle 422 Validation Error', async () => {
      mock.onPut('/accounting/commissions/1/distributions').reply(422, createErrorResponse('Validation failed', 422))
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle invalid reservation ID', async () => {
      mock.onGet('/accounting/sold-units/invalid').reply(400, createErrorResponse('Invalid ID', 400))

      await expect(accountingService.getSoldUnitById('invalid')).rejects.toThrow()
    })

    it('should handle missing required fields', async () => {
      mock.onPost('/accounting/sold-units/100/commission').reply(422, createErrorResponse('Missing required fields', 422))
