...
import { mockEmployee, mockEmployeeList, mockCreateEmployeeRequest, mockCreateEmployeeResponse, mockUpdateEmployeeRequest } from '../fixtures/userFixtures'
...
describe('userService', () => {
  ...
  describe('getEmployees', () => {
    it('should fetch list of employees', async () => {
      mock.onGet('/admin/employees/list_employees').reply(200, { employees: mockEmployeeList })
    ...
    it('should handle different response formats', async () => {
      mock.onGet('/admin/employees/list_employees').reply(200, { data: { employees: mockEmployeeList } })
  ...
  describe('addEmployee', () => {
    it('should create a new employee', async () => {
      mock.onPost('/admin/employees/add_employee').reply(201, mockCreateEmployeeResponse)
    ...
    it('should handle validation errors', async () => {
      mock.onPost('/admin/employees/add_employee').reply(422, { success: false, message: 'Validation failed' })
  ...
  describe('updateEmployee', () => {
    it('should update employee information', async () => {
      const employeeId = 1
      mock.onPut(`/admin/employees/update_employee/${employeeId}`).reply(200, { data: mockEmployee })
  ...
  describe('deleteEmployee', () => {
    it('should delete an employee', async () => {
      const employeeId = 1
      mock.onDelete(`/admin/employees/delete_employee/${employeeId}`).reply(200, { message: 'Deleted' })
  ...
  describe('getEmployee', () => {
    it('should fetch employee details', async () => {
      const employeeId = 1
      mock.onGet(`/admin/employees/show_employee/${employeeId}`).reply(200, { data: mockEmployee })
  ...
  describe('listRoles', () => {
    it('should fetch list of roles', async () => {
      const mockRoles = [{ id: 1, name: 'admin' }, { id: 2, name: 'sales' }]
      mock.onGet('/admin/employees/roles').reply(200, { data: mockRoles })
    ...
    it('should handle query parameters', async () => {
      ...
      mock.onGet('/admin/employees/roles', { params }).reply(200, { data: [] })
    ...
    it('should handle error when fetching roles', async () => {
      mock.onGet('/admin/employees/roles').reply(500, { error: 'Server error' })
  ...
  describe('restoreEmployee', () => {
    it('should restore a deleted employee', async () => {
      ...
      mock.onPatch('/admin/employees/restore').reply(200, { data: mockRestored })
    ...
    it('should handle error when restoring employee', async () => {
      mock.onPatch('/admin/employees/restore').reply(404, { error: 'Employee not found' })
  ...
  describe('Error Handling', () => {
    it('should handle 400 Bad Request', async () => {
      mock.onGet('/admin/employees/list_employees').reply(400, { error: 'Bad request' })

      await expect(userService.getEmployees()).rejects.toThrow()
    })

    it('should handle 401 Unauthorized', async () => {
      mock.onGet('/admin/employees/roles').reply(401, { error: 'Unauthorized' })

      await expect(userService.listRoles()).rejects.toThrow()
    })

    it('should handle 403 Forbidden', async () => {
      mock.onPatch('/admin/employees/restore').reply(403, { error: 'Forbidden' })

      await expect(userService.restoreEmployee(1)).rejects.toThrow()
    })

    it('should handle 404 Not Found', async () => {
      mock.onGet('/admin/employees/show_employee/999').reply(404, { error: 'Not found' })

      await expect(userService.getEmployee(999)).rejects.toThrow()
    })

    it('should handle 422 Validation Error', async () => {
      mock.onPost('/admin/employees/add_employee').reply(422, { error: 'Validation failed', errors: { email: ['Invalid email'] } })

      await expect(userService.addEmployee({})).rejects.toThrow()
    })

    it('should handle 500 Server Error', async () => {
      mock.onGet('/admin/employees/list_employees').reply(500, { error: 'Server error' })

      await expect(userService.getEmployees()).rejects.toThrow()
    })

    it('should handle network errors', async () => {
      mock.onGet('/admin/employees/list_employees').networkError()

      await expect(userService.getEmployees()).rejects.toThrow()
    })

    it('should handle timeout errors', async () => {
      mock.onGet('/admin/employees/roles').timeout()
  ...
  describe('Edge Cases', () => {
    it('should handle empty roles list', async () => {
      mock.onGet('/admin/employees/roles').reply(200, { data: [] })
    ...
    it('should handle null response data', async () => {
      mock.onGet('/admin/employees/roles').reply(200, { data: null })
    ...
    it('should handle empty array response for getEmployees', async () => {
      mock.onGet('/admin/employees/list_employees').reply(200, { data: [] })
